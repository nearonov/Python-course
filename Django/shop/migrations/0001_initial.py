# Generated by Django 4.0.8 on 2024-11-25 21:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('foto', models.ImageField(help_text='Введіть зображення курсів', upload_to='images', verbose_name='Зображення курсів')),
